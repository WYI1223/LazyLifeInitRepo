...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1575414790;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire__crate__api__entry_create_note_impl(port, ptr, rust_vec_len, data_len),
        4 => wire__crate__api__entry_create_task_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__entry_schedule_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__entry_search_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__note_create_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__note_get_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__note_set_tags_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__note_update_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__notes_list_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__tags_list_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        1 => wire__crate__api__configure_entry_db_path_impl(ptr, rust_vec_len, data_len),
        2 => wire__crate__api__core_version_impl(ptr, rust_vec_len, data_len),
        7 => wire__crate__api__init_logging_impl(ptr, rust_vec_len, data_len),
